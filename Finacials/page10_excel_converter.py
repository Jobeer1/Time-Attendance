...
## Use a custom Rand currency format string (works in all openpyxl versions)
from datetime import datetime

# Load data
df = pd.read_csv('page10.csv')
...
wb = Workbook()
ws = wb.active
ws.title = 'Page 10 Write Offs'

# Title
ws.merge_cells('A1:O1')
ws['A1'] = 'PROMED JUN QUARTERLY WRITE OFFS - PAGE 10'
...
# Save workbook
wb.save('page10_corrected.xlsx')
print('Excel report generated: page10_corrected.xlsx')
