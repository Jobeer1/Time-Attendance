...
wb = Workbook()
ws = wb.active
ws.title = 'Page 13 Write Offs'

# Title
ws.merge_cells('A1:O1')
ws['A1'] = 'PROMED JUN QUARTERLY WRITE OFFS - PAGE 13'
...
# Save workbook
wb.save('page13_corrected.xlsx')
print('Excel report generated: page13_corrected.xlsx')
