#!/usr/bin/env python3
"""
Convert page1.csv (JUN - QUARTERLY WRITE OFFS) to professionally formatted Excel file
"""
...
def create_page1_excel():
    # Read the corrected CSV file
    csv_path = 'page1_corrected.csv'
    ...
    exec_ws['A1'] = 'PROMED MEDICAL - QUARTERLY WRITE OFFS REPORT'
    ...
    ws = wb.create_sheet(title="JUN - Quarterly Write Offs")
    
    # Add title
    ws['A1'] = 'JUN - QUARTERLY WRITE OFFS - DETAILED DATA'
    ...
    # Save the file
    output_file = 'page1_corrected.xlsx'
    wb.save(output_file)
    ...
    print(f"Most overdue (150+ days): R {total_150_days:,.2f}")
