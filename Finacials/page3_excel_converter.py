#!/usr/bin/env python3
"""
Convert page3.csv (JUN - QUARTERLY WRITE OFFS - PAGE 3) to professionally formatted Excel file
"""
...
def create_page3_excel():
    ...
    exec_ws['A1'] = 'PROMED MEDICAL - QUARTERLY WRITE OFFS REPORT - PAGE 3'
    ...
    ws = wb.create_sheet(title="JUN - Quarterly Write Offs P3")
    
    # Add title
    ws['A1'] = 'JUN - QUARTERLY WRITE OFFS - PAGE 3 - DETAILED DATA'
