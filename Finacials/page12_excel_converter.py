...
wb = Workbook()
ws = wb.active
ws.title = 'Page 12 Write Offs'

# Title
ws.merge_cells('A1:O1')
ws['A1'] = 'PROMED JUN QUARTERLY WRITE OFFS - PAGE 12'
...
# Save workbook
wb.save('page12_corrected.xlsx')
print('Excel report generated: page12_corrected.xlsx')
