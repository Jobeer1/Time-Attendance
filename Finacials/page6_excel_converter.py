#!/usr/bin/env python3
"""
Simple Excel Converter for Page 6 - JUN QUARTERLY WRITE OFFS
"""
...
def create_page6_excel_simple():
    """Convert page6.csv to Excel with basic formatting"""
    
    try:
        # Read the account data (skip header rows)
        df = pd.read_csv('page6.csv', skiprows=6)
        print(f"✓ Successfully read page6.csv with {len(df)} account records")
        ...
        with pd.ExcelWriter('page6_corrected.xlsx', engine='openpyxl') as writer:
            # Write main data
        ...
        print(f"✓ Successfully created page6_corrected.xlsx")
        return True
...
if __name__ == "__main__":
    print("Creating Page 6 Excel Report (Corrected)...")
    print("=" * 50)
    
    if create_page6_excel_simple():
        print("=" * 50)
        print("✓ Page 6 Excel conversion completed successfully!")
        print("✓ Created: page6_corrected.xlsx")
    else:
